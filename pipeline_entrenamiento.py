...
def train_and_save_pipeline(
    output_path: str = "pipeline_artifacts.pkl",
    random_state: int = 42
):
    """
    ...
    try:
        ...
        X_val_csv = pd.read_csv("x_test.csv") # Renombrado en tu script
        y_val_csv = pd.read_csv("y_test.csv") # Renombrado en tu script
