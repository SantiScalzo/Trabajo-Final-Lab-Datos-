...
def run_prediction_from_excel(
    url: str,
    pipeline_path: str = "pipeline_artifacts.pkl"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pipeline",
        type=str,
        default="pipeline_artifacts.pkl",
        help="Ruta al archivo .pkl o .joblib del pipeline guardado (default: pipeline_artifacts.pkl)"
    )
